...
public class Conf {
    ...
    public static final String TRAININGDATAPATH = RESOURCESPATH + "trainingmusic-cut/";
    ...
    public static final String settingsmfccFile = RESOURCESPATH + "settingsmfcc2.xml";
